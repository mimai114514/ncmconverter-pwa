...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col items-center justify-start font-sans relative overflow-clip">
      ...
      {/* Header */}
      <header className="w-full border-b border-slate-900 z-10 backdrop-blur-md bg-slate-950/70">
